...
Единственное требование — [`uv`](https://docs.astral.sh/uv/), установленный
**отдельным бинарником** (`brew install uv` или официальный установщик), а не
внутрь какого-либо Python. Интерпретатор ставить не нужно: нужную версию
`uv` скачает сам согласно `.python-version`.
